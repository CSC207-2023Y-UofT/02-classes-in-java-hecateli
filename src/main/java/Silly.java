...
public class Silly implements Comparable<Silly>{
     ...
     * This constructor takes in a single int as an argument.
     *
     * @param firstPart the first part of this Silly instance
     * @param secondPart the second part if this Silly instance
     */
    public Silly(String firstPart, String secondPart) { this.name = firstPart + secondPart; }
    ...
    public int compareTo(Silly other) {
         ...
         *                .length() method.
         */
        int lengthThis = this.name.length();
        int lengthOther = other.name.length();
        if (lengthThis > lengthOther) {return 1; }
        else if (lengthThis == lengthOther) {return 0; }
        else {return -1; }
    }
